...
clone_sparse "ejtraderLabs/historical-data" "ejtrader" "*/*m15.csv"
...
# Les 11 autres paires servent au test multi-actifs (backtest/multi_asset.py).
mkdir -p "$DEST/pairs"
cp "$TMP"/ejtrader/*/*m15.csv "$DEST/pairs"/ 2>/dev/null || true
